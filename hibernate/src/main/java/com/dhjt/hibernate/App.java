...
public class App {
	...
	public static void temp() {
		...
		listMap.put("案卷目录", "1");
		listMap.put("案内目录", "2");
		Set<Entry<String, String>> tem = listMap.entrySet();
		for (Entry<String, String> entry : tem) {
			System.out.println("2018年12月13日下午6:03:29->" + entry.getKey());
			System.out.println("2018年12月13日下午6:03:29->" + entry.getValue());
		}
//		forEach(BiConsumer<? super String, ? super List> action)
